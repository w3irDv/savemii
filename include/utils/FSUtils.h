...
namespace FSUtils {
    ...
    bool setOwnerAndMode(uint32_t owner, uint32_t group, FSMode mode, const std::string &path, FSError &fserror);
    bool setOwnerAndModeRec(uint32_t owner, uint32_t group, FSMode mode, const std::string &path, FSError &fserror);
