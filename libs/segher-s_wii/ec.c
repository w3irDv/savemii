...
// w3irdv 2026 - wii u has no /dev/random
...
// y**2 + x*y = x**3 + x**2 + b
static u8 ec_b[30] __attribute__((nonstring)) =
...
[[maybe_unused]] static void elt_print(char *name, u8 *a)
{
    u32 i;
...
static const u8 square[16] __attribute__((nonstring)) =
...
[[maybe_unused]] static int point_is_on_curve(u8 *p)
{
    u8 s[30], t[30];
    u8 *x, *y;
