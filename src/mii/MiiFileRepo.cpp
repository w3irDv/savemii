...
template<>
uint8_t *MiiFileRepo<WiiUMii, WiiUMiiData>::find_mii_id_in_stadio(MiiData *miidata) {
...
template<>
bool MiiFileRepo<WiiUMii, WiiUMiiData>::find_stadio_empty_frame(uint16_t &frame) {
...
template<>
bool MiiFileRepo<WiiMii, WiiMiiData>::set_stadio_path() {
    path_to_stadio.assign("");
    return true;
}

template<>
bool MiiFileRepo<WiiUMii, WiiUMiiData>::set_stadio_path() {
...
template<>
bool MiiFileRepo<WiiMii, WiiMiiData>::open_and_load_stadio() {
    return true;
}

template<>
bool MiiFileRepo<WiiUMii, WiiUMiiData>::open_and_load_stadio() {
...
template<>
bool MiiFileRepo<WiiMii, WiiMiiData>::persist_stadio() {
    return true;
}

template<>
bool MiiFileRepo<WiiUMii, WiiUMiiData>::persist_stadio() {
...
template<>
uint8_t *MiiFileRepo<WiiUMii, WiiUMiiData>::find_stadio_empty_location() {
    uint8_t zero[10] = {0};
...
template<>
bool MiiFileRepo<WiiMii, WiiMiiData>::import_miidata_in_stadio([[maybe_unused]] MiiData *mii_data) {
    return true;
}


template<>
bool MiiFileRepo<WiiUMii, WiiUMiiData>::import_miidata_in_stadio(MiiData *miidata) {
...
template<>
bool MiiFileRepo<WiiMii, WiiMiiData>::fill_empty_stadio_file() {
    return true;
}

template<>
bool MiiFileRepo<WiiUMii, WiiUMiiData>::fill_empty_stadio_file() {
...
template<>
bool MiiFileRepo<WiiMii, WiiMiiData>::init_stadio_file() {
    return true;
}

template<>
bool MiiFileRepo<WiiUMii, WiiUMiiData>::init_stadio_file() {
    std::string db_filepath = this->path_to_stadio;
...
bool MiiFileRepo<MII, MIIDATA>::import_miidata(MiiData *miidata, bool in_place, size_t index) {
    ...
    // STADIO
    if (!in_place)
        import_miidata_in_stadio(miidata);
